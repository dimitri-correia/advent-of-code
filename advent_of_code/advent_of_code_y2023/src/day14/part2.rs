use crate::day14::common::{change_order_col_row, parse_input_col_row, Grid, Order, Shape};
...
mod tests {
    use super::*;
    use crate::day14::common::{parse_char, parse_input_row_col, Order};
    use itertools::Itertools;

    #[test]
    fn actual_challenge() {
        let output = part_2_actual_challenge();        assert_eq!("87273", output);
    }
